...
import {fetchDashboardCountingSettings, isDashboardApiError} from "@/lib/dashboard-api";
...
export default async function CountingPage({
    ...
    const settings = await fetchDashboardCountingSettings(guildId).catch(error => {
