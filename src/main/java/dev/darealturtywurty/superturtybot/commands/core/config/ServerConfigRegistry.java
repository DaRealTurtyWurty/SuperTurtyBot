...
public class ServerConfigRegistry {
    ...
    public static final ServerConfigOption LEVELLING_ITEM_CHANCE = SERVER_CONFIG_OPTIONS.register(
            "levelling_item_chance", new ServerConfigOption.Builder().dataType(DataType.INTEGER)
    ...
    public static final ServerConfigOption DISABLED_LEVELLING_CHANNELS = SERVER_CONFIG_OPTIONS.register(
            "disabled_levelling_channels", new ServerConfigOption.Builder().dataType(DataType.STRING)
    ...
    public static final ServerConfigOption IS_STARBOARD_MEDIA = SERVER_CONFIG_OPTIONS.register(
            "is_starboard_media_only", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN)
    ...
    public static final ServerConfigOption DISABLE_LEVEL_UP_MESSAGES = SERVER_CONFIG_OPTIONS.register(
            "disable_level_up_messages", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN)
    ...
    public static final ServerConfigOption LEVEL_UP_MESSAGE_CHANNEL = SERVER_CONFIG_OPTIONS.register(
            "level_up_message_channel", new ServerConfigOption.Builder().dataType(DataType.LONG)
    ...
    public static final ServerConfigOption SHOULD_EMBED_LEVEL_UP_MESSAGES = SERVER_CONFIG_OPTIONS.register(
            "should_embed_level_up_message", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN)
    ...
    public static final ServerConfigOption SHOULD_MODERATORS_JOIN_THREADS = SERVER_CONFIG_OPTIONS.register(
            "should_moderators_join_threads", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN)
    ...
    public static final ServerConfigOption LOGGING_CHANNEL = SERVER_CONFIG_OPTIONS.register("logging_channel",
            new ServerConfigOption.Builder().dataType(DataType.LONG)
                    ...
                    .valueFromConfig(GuildConfig::getLoggingChannel).validator(Validators.TEXT_CHANNEL_VALIDATOR)
                    .build());
    ...
    public static final ServerConfigOption OPT_IN_CHANNELS = SERVER_CONFIG_OPTIONS.register("opt_in_channels",
            new ServerConfigOption.Builder().dataType(DataType.STRING).serializer(GuildConfig::setOptInChannels)
                    .valueFromConfig(GuildConfig::getOptInChannels).validator((event, value) -> {
                        final String[] channels = value.split("[\s;]");
                        for (final String channelStr : channels) {
                            if (!Validators.GUILD_CHANNEL_VALIDATOR.test(event, channelStr)) return false;
                        }
