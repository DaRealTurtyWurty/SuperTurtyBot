...
public class ServerConfigRegistry {
    ...
    public static final ServerConfigOption IS_STARBOARD_ENABLED = SERVER_CONFIG_OPTIONS.register("starboard_enabled",
            new ServerConfigOption.Builder().dataType(DataType.BOOLEAN).serializer(
    ...
    public static final ServerConfigOption MINIMUM_STARS = SERVER_CONFIG_OPTIONS.register("minimum_stars",
            new ServerConfigOption.Builder().dataType(DataType.INTEGER).serializer(
    ...
    public static final ServerConfigOption LEVELLING_COOLDOWN = SERVER_CONFIG_OPTIONS.register("level_cooldown",
            new ServerConfigOption.Builder().dataType(DataType.LONG).serializer(
    ...
    public static final ServerConfigOption LEVELLING_ITEM_CHANCE = SERVER_CONFIG_OPTIONS.register(
            "levelling_item_chance", new ServerConfigOption.Builder().dataType(DataType.INTEGER).serializer(
    ...
    public static final ServerConfigOption DISABLED_LEVELLING_CHANNELS = SERVER_CONFIG_OPTIONS.register(
            "disabled_levelling_channels", new ServerConfigOption.Builder().dataType(DataType.STRING).serializer(
    ...
    public static final ServerConfigOption IS_STARBOARD_MEDIA = SERVER_CONFIG_OPTIONS.register(
            "is_starboard_media_only", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN).serializer(
    ...
    public static final ServerConfigOption DISABLE_LEVEL_UP_MESSAGES = SERVER_CONFIG_OPTIONS.register(
            "disable_level_up_messages", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN).serializer(
    ...
    public static final ServerConfigOption LEVEL_UP_MESSAGE_CHANNEL = SERVER_CONFIG_OPTIONS.register(
            "level_up_message_channel", new ServerConfigOption.Builder().dataType(DataType.LONG).serializer(
    ...
    public static final ServerConfigOption SHOULD_EMBED_LEVEL_UP_MESSAGES = SERVER_CONFIG_OPTIONS.register(
            "should_embed_level_up_message", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN).serializer(
    ...
    public static final ServerConfigOption SHOULD_MODERATORS_JOIN_THREADS = SERVER_CONFIG_OPTIONS.register(
            "should_moderators_join_threads", new ServerConfigOption.Builder().dataType(DataType.BOOLEAN).serializer(
    ...
    public static final ServerConfigOption OPT_IN_CHANNELS = SERVER_CONFIG_OPTIONS.register("opt_in_channels",
            new ServerConfigOption.Builder().dataType(DataType.STRING).serializer(GuildConfig::setOptInChannels)
    ...
    public static final ServerConfigOption ARE_WARNINGS_MODERATOR_ONLY = SERVER_CONFIG_OPTIONS.register(
