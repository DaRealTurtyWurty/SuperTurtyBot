...
public class PokerCheckCommand extends PokerSubcommand {
    public PokerCheckCommand() {
        this("check", "Check and move to the next stage");
    }

    protected PokerCheckCommand(String name, String description) {
