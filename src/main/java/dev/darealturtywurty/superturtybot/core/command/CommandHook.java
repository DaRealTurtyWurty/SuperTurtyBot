...
//        }
    ...
    private static Set<CoreCommand> createCommands() {
        ...
        commands.add(new SteamGamesCommand());
        commands.add(new SteamIDCommand());
        commands.add(new RobloxAvatarCommand());
        commands.add(new RobloxUsernameCommand());
        commands.add(new RobloxFriendsCommand());
        commands.add(new FavouriteRobloxGamesCommand());
        commands.add(new WikipediaCommand());
        commands.add(new SteamGameDetailsCommand());
