...
public class ShopItemRegistry {
    ...
    public static final ShopItem APPLE = SHOP_ITEMS.register("apple",
            new ShopItem.Builder().image("/economy/items/apple.png").description("An apple a day keeps the doctor away!").price(50).build());

    public static final ShopItem BANANA = SHOP_ITEMS.register("banana",
            new ShopItem.Builder().image("/economy/items/banana.png").description("Try not to get peeled!").price(75).build());

    public static final ShopItem CHERRY = SHOP_ITEMS.register("cherry",
            new ShopItem.Builder().image("/economy/items/cherry.png").description("A cherry on top of your day!").price(100).build());

    public static final ShopItem ORANGE = SHOP_ITEMS.register("orange",
            new ShopItem.Builder().image("/economy/items/orange.png").description("A juicy orange!").price(125).build());
}