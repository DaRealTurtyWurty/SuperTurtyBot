...
public class DenySuggestionCommand extends CoreCommand {
    ...
    protected void runNormalMessage(MessageReceivedEvent event) {
        ...
        final CompletableFuture<Suggestion> suggestion = SuggestionManager.respondSuggestion(event.getGuild(),
            suggestionChannel, event.getMember(), suggestionNumber, response, Response.Type.DENIED);
        ...
        suggestion.thenAccept(sug -> {
            ...
            event.getAuthor().openPrivateChannel().queue(channel -> {
                ...
                embed.setTitle("✅ Response successfully added!", "https://discord.com/channels/"
                    + event.getGuild().getIdLong() + "/" + suggestionChannel.getIdLong() + "/" + sug.messageId());
